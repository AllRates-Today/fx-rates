...
|---|---|---|
| [`@allratestoday/sdk`](https://www.npmjs.com/package/@allratestoday/sdk) | `npm install @allratestoday/sdk` | Full-featured SDK (historical, batch, webhooks) |
| [`react-currency-localizer-realtime`](https://www.npmjs.com/package/react-currency-localizer-realtime) | `npm install react-currency-localizer-realtime` | React hooks & components |
| **`fx-rates`** *(this package)* | `npm install fx-rates` | **Lightweight one-function + CLI** |
